...
console.log(response.choices[0].message.content);`}</div>
          ...
          <div style={{ marginTop: '40px', padding: '20px', background: 'rgba(124, 58, 237, 0.06)', borderRadius: '10px', border: '1px solid rgba(124, 58, 237, 0.25)' }}>
      ...
      <section className="quick-links container">
        <div style={{ paddingTop: '60px', paddingBottom: '60px', borderRadius: '16px', padding: '60px 40px', background: 'linear-gradient(135deg, rgba(124, 58, 237, 0.1) 0%, rgba(79, 70, 229, 0.06) 50%, rgba(59, 130, 246, 0.04) 100%)', border: '1px solid rgba(124, 58, 237, 0.25)', textAlign: 'center' }}>
